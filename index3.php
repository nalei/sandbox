...
<header class="header">
    <article class="wrapper">
        ...
        <nav class="b-menu">
            ...
            <a href="#" class="b-menu__item" data-scroll-to="slide5" data-target-analytic="menurequest" onclick="yaCounter48306422.reachGoal('serverrequest'); return true;">Подключение</a>
        </nav>
    </article>
...
<div class="content">
    <section class="masthead masthead_barbie">
        <article class="wrapper">
            <div class="masthead_in">
                ...
                <a href="#" class="btn-blue btn" data-scroll-to="slide5" data-target-analytic="request" onclick="yaCounter48306422.reachGoal('serverrequest'); return true;">заявка на подключение</a>
            </div>
        </article>
        <div class="scroll-down" data-target-analytic="listdown">
            <img src="images/icon/scroll.svg" alt="">
        </div>
        <img class="bg" src="images/bg_barbie.jpg" alt="">
    </section>
    ...
    <section class="subscribe" id="slide3">
        <article class="wrapper">
            ...
            <button class="btn btn-blue" data-scroll-to="slide5" data-target-analytic="pricerequest" onclick="yaCounter48306422.reachGoal('serverrequest'); return true;">Заявка на подключение</button>
        </article>
    </section>
        ...
        <article class="wrapper">
            ...
            <div class="info-call_list">
                <div class="info-call-item">
                    ...
                    <button class="btn btn-blue fancybox" data-mode="1" data-fancybox-href="#popup" data-target-analytic="first" onclick="yaCounter48306422.reachGoal('serverleed'); return true;">отправить заявку</button>
                </div>
                <div class="info-call-item">
                    <div class="info-call-item_in">
                    ...
                    <button class="btn btn-blue fancybox" data-mode="2" data-fancybox-href="#popup" data-target-analytic="second" onclick="yaCounter48306422.reachGoal('serverleed'); return true;">отправить заявку</button>
                </div>
                <div class="info-call-item">
                    <div class="info-call-item_in">
                        <div class="small">не могу <br/> сказать точно</div>
                    </div>
                    <button class="btn btn-blue fancybox" data-mode="3" data-fancybox-href="#popup" data-target-analytic="third" onclick="yaCounter48306422.reachGoal('serverleed'); return true;">отправить заявку</button>
                </div>
            </div>
        </article>
    </section>
