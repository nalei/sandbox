...
})(window,document,'script','dataLayer','GTM-NJBK8L6');</script>
<!-- End Google Tag Manager -->
</head>

<body>
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NJBK8L6"
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="#" data-scroll-to="slide5" data-target-analytic="menurequest" onclick="yaCounter49657954.reachGoal('kanrequest'); return true;">Подключение</a></li>
                </ul>
            </div><!--/.nav-collapse -->
                ...
                <div class="row">
                    <div class="col-md-5 col-md-offset-7">
                        ...
                        <div class="button-block">
                            <a href="#" class="btn-blue btn fancybox" data-mode="3" data-fancybox-href="#popup" data-target-analytic="request" onclick="yaCounter49657954.reachGoal('kanrequest'); return true;">заявка на подключение</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="application-area" id="slide2">
        <article class="container">
            ...
            <div class="application-area-list row">
                <div class="application-area-item col-sm-6 col-md-4" data-target-analytic="robotinfo">
                    <div class="front">
                        <div class="center">
                            <div class="icon">
                        ...
                        <p>Робот- <br> информатор</p>
                        <div class="dots"><span></span><span></span><span></span></div>
                    </div>
                    <div class="back">
                        <p>Робот- <br> информатор</p>
                        <div class="back-preview">
                            <img src="/images/icon/icon1-active.png" alt="" width="62">
                        </div>
                        <ul>
                            <li>Обзвонили всех клиентов</li>
                            <li>Пригласили на мероприятие</li>
                            <li>Узнали, кто согласился</li>
                        </ul>
                    </div>
                </div>
                <div class="application-area-item col-sm-6 col-md-4" data-target-analytic="robotsale">
                    <div class="front">
                        <div class="center">
                            <div class="icon">
                        ...
                        <p>Робот- <br> продавец</p>
                        <div class="dots"><span></span><span></span><span></span></div>
                    </div>
                    <div class="back">
                        <p>Робот- <br> продавец</p>
                        <div class="back-preview">
                            <img src="/images/icon/icon2-active.png" alt="" width="60">
                        </div>
                        <ul>
                            <li>Обзвонили постоянных клиентов</li>
                            <li>Предложили новый продукт</li>
                            <li>Записали, кто заинтересовался</li>
                        </ul>
                    </div>
                </div>
                <div class="application-area-item col-sm-6 col-md-4" data-target-analytic="robotadmin">
                    <div class="front">
                        <div class="center">
                            <div class="icon">
                        ...
                        <p>Робот- <br> администратор</p>
                        <div class="dots"><span></span><span></span><span></span></div>
                    </div>
                    <div class="back">
                        <p>Робот- <br> администратор</p>
                        <div class="back-preview">
                            <img src="/images/icon/icon3-active.png" alt="" width="56">
                        </div>
                        <ul>
                            <li>Обзвонили клиентов по записи</li>
                            <li>Подтвердили бронирование</li>
                            <li>Выявили отказавшихся</li>
                        </ul>
                    </div>
                </div>
                <div class="application-area-item col-sm-6 col-md-4" data-target-analytic="robotinterview">
                    <div class="front">
                        <div class="center">
                            <div class="icon">
                        ...
                        <p>Робот- <br> интервьюер</p>
                        <div class="dots"><span></span><span></span><span></span></div>
                    </div>
                    <div class="back">
                        <p>Робот- <br> интервьюер</p>
                        <div class="back-preview">
                            <img src="/images/icon/icon4-active.png" alt="" width="60">
                        </div>
                        <ul>
                            <li>Обзвонили получивших услугу</li>
                            <li>Спросили о качестве</li>
                            <li>Записали оценки</li>
                        </ul>
                    </div>
                </div>
                <div class="application-area-item col-sm-6 col-md-4" data-target-analytic="robotconsult">
                    <div class="front">
                        <div class="center">
                            <div class="icon">
                                <img src="/images/icon/icon5.svg" alt="">
                            </div>
                        </div>
                        <p>Робот- <br> консультант</p>
                        <div class="dots"><span></span><span></span><span></span></div>
                    </div>
                    <div class="back">
                        <p>Робот- <br> консультант</p>
                        <div class="back-preview">
                            <img src="/images/icon/icon5-active.png" alt="" width="56">
                        </div>
                        <ul>
                            <li>Приняли входящие звонки</li>
                            <li>Узнали, что интересует клиентов</li>
                            <li>Соединили со специалистами</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="subscribe" id="slide3">
        <article class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <button class="btn btn-blue fancybox" data-fancybox-href="#popup" data-target-analytic="pricerequest" onclick="yaCounter49657954.reachGoal('kanrequest'); return true;">Заявка на подключение</button>
                </div>
            </div>
        </article>
    </section>

    <section class="bottom-carousel" id="slide4">
        <div class="carousel-item">
            <div class="product-small first" data-target-analytic="hoff">
                <div class="logo-product">
                    <img width="51px" src="images/hoff_grey.png" alt="">
                </div>
                <div class="logo-big">
                    <img src="images/logo-color2.png" alt="">
                </div>
                <div class="product-small_in">
                    <div class="title">
                        ROBOT_CALLS
                    </div>
                    <div class="text">
                        Обзваниваем 10 000 клиентов ежеденвно
                    </div>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            <div class="product-small" data-target-analytic="ulmart">
                <div class="logo-product">
                    <img width="51px" src="images/ulmart_grey.png" alt="">
                </div>
                <div class="logo-big">
                ...
                <div class="product-small_in">
                    ...
                    <div class="text">
                        Сократили расходы на колл-центр в 3 раза
                    </div>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            <div class="product-small" data-target-analytic="homecredit">
                <div class="logo-product">
                    <img width="55px" src="images/home_credit_grey.png" alt="">
                </div>
                <div class="logo-big">
                    <img src="images/logo-color3.png" alt="">
                </div>
                <div class="product-small_in">
                    <div class="title">
                        ROBOT_CALLS
                    ...
                    <div class="text">
                        Принимаем звонки службы поддержки 24 / 7 по всей стране
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="info-call_list row">
                <div class="info-call-item col-md-4">
                    <div class="info-call-item_in">
                        ...
                        <div class="small"> тысяч <br/> клиентов</div>
                    </div>

                    <button class="btn btn-blue fancybox" data-mode="1" data-fancybox-href="#popup" data-target-analytic="first" onclick="yaCounter49657954.reachGoal('kanleed'); return true;">отправить заявку</button>
                </div>
                <div class="info-call-item col-md-4">
                    <div class="info-call-item_in">
                    ...
                    <button class="btn btn-blue fancybox" data-mode="2" data-fancybox-href="#popup" data-target-analytic="second" onclick="yaCounter49657954.reachGoal('kanleed'); return true;">отправить заявку</button>
                </div>
                <div class="info-call-item col-md-4">
                    <div class="info-call-item_in">
                        <div class="small">не могу <br/> сказать точно</div>
                    </div>
                    <button class="btn btn-blue fancybox" data-mode="3" data-fancybox-href="#popup" data-target-analytic="third" onclick="yaCounter49657954.reachGoal('kanleed'); return true;">отправить заявку</button>
                </div>
            </div>
        </article>
    </section>
...
<script src="js/libs/feedback.js"></script>
<script src="js/script.js"></script>


<div class="popup" id="popup">
    <a title="Close" class="fancybox-item fancybox-close" href="#" data-target-analytic="close"><svg width="14px" height="14px" viewBox="0 0 14 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g transform="translate(-1044.000000, -1450.000000)" fill="#fff"> <path d="M1051,1455.6 L1056.6,1450 L1058,1451.4 L1052.4,1457 L1058,1462.6 L1056.6,1464 L1051,1458.4 L1045.4,1464 L1044,1462.6 L1049.6,1457 L1044,1451.4 L1045.4,1450 L1051,1455.6 Z"></path> </g> </g> </svg></a>
    <div class="js-feedback-content">
        <div class="js-feedback-start">
            <div class="title">Заявка на подключение</div>
            <form action="" class="js-feedback-form">
                <div class="form-item" data-target-analytic="sendchoose">
                    <select data-placeholder="выберите" name="mode" id="mode-field">
                        <option></option>
                        <option selected value="1">Нужно обзвонить от 1 до 10 тыс. клиентов</option>
                        <option value="2">Больше 10 тыс. клиентов</option>
                        <option value="3">Не могу сказать точно</option>
                    </select>
                </div>
                <div class="form-item">
                    <input name="phone" data-name="text" class="tel js-feedback-field" type="text" placeholder="" id="popup-tel" data-target-analytic="sendphone">
                    <label for="popup-tel">Ваш контактный номер телефона</label>
                </div>
                <p>Мы свяжемся с вами, чтобы уточнить некоторые детали, <br>
                    и приступим к подключению.</p>
                <button class="btn btn-white js-feedback-submit _disabled" type="button" data-target-analytic="send" onclick="yaCounter49657954.reachGoal('REQUEST_FORM'); dataLayer.push({'event': 'formsend'});">отправить</button>
            </form>
        </div>
        <div class="js-feedback-result" style="display: none;">
            Спасибо за обращение!<br>
            <small>Мы свяжемся с вами, чтобы уточнить некоторые детали, и приступим к подключению.</small>
        </div>
    </div>
</div>
...
(function(){ var widget_id = 'aFqcQWzbqU';var d=document;var w=window;function l(){var s = document.createElement('script'); s.type = 'text/javascript'; s.async = true;s.src = '//code.jivosite.com/script/widget/'+widget_id; var ss = document.getElementsByTagName('script')[0]; ss.parentNode.insertBefore(s, ss);}if(d.readyState=='complete'){l();}else{if(w.attachEvent){w.attachEvent('onload',l);}else{w.addEventListener('load',l,false);}}})();
</script>
